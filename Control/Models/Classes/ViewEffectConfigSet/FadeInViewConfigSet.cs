...
{
    public class FadeInViewConfigSet : IViewEffectConfigSet
    {
        ...
        public FadeInViewConfigSet(byte brightnessLevel, uint transitionTime)
        {
        ...
        {
            return AvailableViewEffects.UniversalFadeIn;
        }
    }
}
