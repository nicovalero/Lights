...
namespace UI.Models.Structs
{
    internal struct MidiEffectLink_ViewModel
    {
        ...
        private IViewEffect _effect;
        private List<IViewLight> _lights;
        private IViewEffectConfigSet _configuration;
        ...
        public IViewEffect Effect { get { return _effect; } set { _effect = value; } }
        public string EffectName { get { return _effect.GetName(); } }
        public List<IViewLight> Lights { get { return _lights; } set { _lights = value; } }
        ...
        public IViewEffectConfigSet Configuration { get { return _configuration; } set { _configuration = value; } }

        public MidiEffectLink_ViewModel(MidiChannel channel, MidiVelocity velocity, MidiNote note, 
            IViewEffect effect, List<IViewLight> lights, IViewEffectConfigSet configuration)
        {
            _channel = channel;
            _velocity = velocity;
            _note = note;
