...
namespace UI
{
    internal static class HueEffect_ToCardConfigConverter
    {
        ...
        private static List<Color> GetColorListFromViewEffect(IViewEffect effect)
        {
        ...
        private static IconChar GetIconFromViewEffect(IViewEffect effect)
        {
        ...
        public static List<CardConfigList_ViewModel> ConvertLightEffect_ToCardConfig(List<IViewEffect> effects)
        {
            ...
            {
                var colorList = GetColorListFromViewEffect(effect);
                var icon = GetIconFromViewEffect(effect);
                list.Add(new CardConfigList_ViewModel(effect.GetName(), effect, effect.GetName(), colorList[0], colorList[1], icon, effect.GetEffectTypeName()));
            }
